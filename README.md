A [Giter8](http://www.foundweekends.org/giter8/) template for creating HMRC Digital Scala Play 2.6 Microservice Without MongoDB
...
* Run the command
    ...
    `g8 {GITHUB_USER}/template-play-26-microservice-without-mongo.g8 --servicename="New Shiny Service" --serviceTargetPort="9999"`
